# Preregistration for Quantitative Methods {#Preregistration}

**We encourage staff to preregister their research as standard.**

## What is preregistration?

[Preregistration](https://www.pnas.org/doi/10.1073/pnas.1708274114) involves publishing your plans in a protocol for research *before* you conduct the research. A preregistration can benefit research quality if it is version-controlled, time-stamped, and deposited in a publicly accessible repository. This practice ensures that any change to the research plans or protocol can be traced, which disincentivizes presenting a changed protocol as the original, intended protocol - this is relevant if such changes are data-inspired. The more detailed the preregistered protocol, the more it prevents results being influenced -- even inadvertently -- by undisclosed flexibility in research practices, which is known to affect replicability. Most pre-registered information should include the following:

1.  A statement of the hypotheses/research questions being assessed

<!-- -->

2.  A clear methodology that can be reproduced by other researchers

<!-- -->

3.  The variables that will be measured and theoretical lens by which these will be viewed

<!-- -->

4.  An indication of the intended sample size (ideally justified with a power analysis for confirmatory research), how this will be obtained (recruitment) and what criteria will govern inclusion and exclusion of participants and data.

<!-- -->

5.  A detailed description of the intended data analysis that will underlie any inferences drawn
...
There may be different requirements for each type of research and the [Equator Network](https://www.equator-network.org/) have provided [guidance](https://www.equator-network.org/?post_type=eq_guidelines&eq_guidelines_study_design=study-protocols&eq_guidelines_clinical_specialty=0&eq_guidelines_report_section=0&s=+) on what to include in protocols for a selection of different designs. You can also publish the protocol as a peer-reviewed journal article, but this should be considered in addition to the registrations below given the time the peer-review process takes. One way around this may be to deposit the protocol as a pre-print on a server such as [PsyArXiv](https://psyarxiv.com/) (if your chosen journal facilitates this; see [Sherpa Romeo](https://v2.sherpa.ac.uk/romeo/)).
...
-   It is an ethical requirement as per the [Declaration of Helsinki](https://www.wma.net/policies-post/wma-declaration-of-helsinki/) that every clinical trial, if considered medical, must be registered in a publicly accessible database before recruitment of the first participant. A list of other registration sites are: [Primary Registries in the WHO Registry Network](https://www.who.int/tools/clinical-trials-registry-platform) or an [ICMJE approved registry](http://www.icmje.org/about-icmje/faqs/clinical-trials-registration/). Please note that some of these may incur a charge. For trials you should also complete a [SPIRIT protocol](https://www.equator-network.org/reporting-guidelines/spirit-2013-statement-defining-standard-protocol-items-for-clinical-trials/) document for your Trial Master file.
