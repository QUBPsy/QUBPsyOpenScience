...
**We encourage staff to share their data where appropriate to do so.** 
...
The guidelines on data deposit at Queen's University Belfast (available at [Standard Operating Procedures](https://libguides.qub.ac.uk/ResearchDataManagement)). Further support on Research Data Management is available from the [library / Open Research Team](https://libguides.qub.ac.uk/ResearchDataManagement/Introduction).  
...
Within the university, Open data is supported by the [Open Research Team](https://libguides.qub.ac.uk/openaccess/team). They can help with producing Data Management Plans, which are required by most funders, obtaining DOIs, and with getting access to the [Active Data Storage](https://libguides.qub.ac.uk/ResearchDataManagement/ResearchDataStorage) (ADS) service for large datasets. If you have any questions about these aspects, get in touch with [rdm\@qub.ac.uk](mailto:rdm@qub.ac.uk).
