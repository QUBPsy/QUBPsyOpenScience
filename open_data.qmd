...
The guidelines on data deposit at Queen's University Belfast (available at [Standard Operating Procedures](https://www.qub.ac.uk/Research/Governance-ethics-and-integrity/Policies-procedures-and-guidelines/Standard-operating-procedures/)).  
...
Please contact the lead author, Professor Jones ([a.jones\@qub.ac.uk),](mailto:ab.smith@ulster.ac.uk) with any publications arising from the data. 

## Where to share data? 

There are many ways to make data open. QUB offers researchers to share their research data through PURE (<https://pure.qub.ac.uk/en/datasets/>). Some QUB Psychology data is being shared through the following portals: 
...
-   Example: [Reid and Dessing (2018)](https://osf.io/n4yjr/) 
...
For an overview of different online data repositories, see [https://www.re3data.org/](https://www.re3data.org/) 
