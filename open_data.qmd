...
-   Examples: [Reid and Dessing (2018)](https://osf.io/n4yjr/), [Schultze, Gerlach and Rittich (2017)](https://osf.io/xvhgg/)\]   [Zenodo](https://zenodo.org/) 

-   Servers based at CERN    Beyond that, the following online data repositories are frequently used in our field:    [Research Box](https://researchbox.org/)  

-   Mirroring [AsPredicted.org](https://aspredicted.org/) 

Data and materials archive    For an overview of different online data repositories, see <https://www.re3data.org/>
